...
$meta_keywords = "Microsoft 365 Email India, office 365 reseller, Office 365 Business Mail, Microsoft Email Hosting, Microsoft 365 Partner India, Business Email Solutions, Cloud Email India, Skynetiks Technologies Office 365";
...
background-size: 100% 100%;">
    <div class="container">
        <div class="text-center city_banner">
            <h4>Microsoft 365: The Enterprise Solution Built for Trust and Performance</h4>
            <div class="btns-box">
...
<section class="google_workspace_content">
    <div class="container">
        <div class="sec-title centered">
            <h2>Why Enterprises Trust Microsoft 365 for Business Growth </h2>
        </div>
        <div class="row">
            <div class="col-md-8">
            ...
            <div class="col-md-3 ">
                <div class="pricingTable10">
                    <div class="pricingTable-header">
                        ...
                        <span class="price-value">
                            <span class="currency">₹</span>21960
                            <span class="month">/Yr</span>
                        </span>
                    </div>
                    <div class="pricing-content">
