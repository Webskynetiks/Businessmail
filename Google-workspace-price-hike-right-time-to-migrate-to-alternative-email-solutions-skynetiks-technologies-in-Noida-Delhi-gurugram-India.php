...
<section class="about-page-section">
  <div class="sec-title centered">
    <h2 style="padding: 5px">Expert Mail Migration Services with Guaranteed Data Backup</h2>
  </div>
  ...
  <div class="container">
    ...
    <h2 style="font-size: 24px; font-weight: 600;  color:#243559">
      Our Email Migration Services Cover:
    </h2>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="text-center logo-image-slider">
          <img src="images/google-workspace-support-partner-india.webp" style="    width: 100%;
    margin-bottom: 10px;
    background: #d2ecfa;
    padding: 22px;">
          <h5 style="color: red;font-weight: 700;"><img src="images/google-workspace-technical-support-india.png" alt=""></h5>
          <h5>
