...
<section class="city" style="background:linear-gradient(rgb(33 109 161 / 81%), rgb(1 87 146 / 33%)),url(images/custom-mail-hosting-services-india.jpg);background-repeat: no-repeat;
	...
	<div class="container">
		<div class="text-center city_banner">
			<h4>Custom Business Email Hosting: Enhance Productivity and Brand Identity</h4>
			<div class="btns-box">
...
<section class="google_workspace_content">
	<div class="container">
		<div class="sec-title centered">
							<h2>Affordable Custom Mail Solutions Tailored for Enterprise Email Security</span> </h2>
						</div>
		<div class="row">
			<div class="col-md-8">
