...
<style>
    ...
    .container {
      max-width: 1140px; margin: auto; padding: 40px 20px;
    }
    .main-title {
      font-size: 2.5rem; color: #1a73e8;
...
<section>
 ...
 <div class="container">
    ...
    <ul class="bullet-list">
      <li class="bullet-item">Full email setup on business domain</li>
      <li class="bullet-item">Admin panel with user, group & policy controls</li>
      <li class="bullet-item">Assisted email migration & data import</li>
      <li class="bullet-item">Spam protection, backup & mobile/web testing</li>
      <li class="bullet-item">24×7 technical guidance from experts</li>
    </ul>
